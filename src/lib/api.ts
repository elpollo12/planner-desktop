...
export const waterBottlesApi = {
  createMovement: (sessionToken: string, movement: CreateWaterBottlesMovement) =>
    invoke<WaterBottlesMovement>('create_water_bottles_movement', { sessionToken, movement }),

  getMovements: (sessionToken: string, page?: number, pageSize?: number) =>
    invoke<PaginatedResponse<WaterBottlesMovement>>('get_water_bottles_movements', { sessionToken, page, pageSize }),
...
export const fuelApi = {
  createMovement: (sessionToken: string, movement: CreateFuelMovement) =>
    invoke<FuelMovement>('create_fuel_movement', { sessionToken, movement }),

  getMovements: (sessionToken: string, page?: number, pageSize?: number) =>
    invoke<PaginatedResponse<FuelMovement>>('get_fuel_movements', { sessionToken, page, pageSize }),
...
export const vacuumApi = {
  createAction: (sessionToken: string, input: CreateVacuumAction) =>
    invoke<VacuumAction>('create_vacuum_action', { sessionToken, input }),

  getActions: (sessionToken: string, page?: number, pageSize?: number) =>
    invoke<PaginatedResponse<VacuumAction>>('get_vacuum_actions', { sessionToken, page, pageSize }),
...
export const materialsApi = {
  ...
  // Movimientos
  createMovement: (sessionToken: string, movement: CreateMaterialMovement) =>
    invoke<MaterialMovement>('create_material_movement', { sessionToken, movement }),

  getMovements: (sessionToken: string, materialId?: string, page?: number, pageSize?: number) =>
    invoke<PaginatedResponse<MaterialMovement>>('get_material_movements', { sessionToken, materialId, page, pageSize }),
...
export const logisticsRequestsApi = {
  create: (sessionToken: string, input: CreateLogisticsRequest) =>
    invoke<LogisticsRequest>('create_logistics_request', { sessionToken, input }),

  list: (sessionToken: string, requestType?: string, status?: string, page?: number, pageSize?: number) =>
    invoke<PaginatedResponse<LogisticsRequest>>('list_logistics_requests', { sessionToken, requestType, status, page, pageSize }),
...
export const logisticsReportsApi = {
  getReport: (sessionToken: string, periodStart: string, periodEnd: string) =>
    invoke<LogisticsReport>('get_logistics_report', { sessionToken, periodStart, periodEnd }),
};
