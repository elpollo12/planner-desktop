...
export function FluidProductSelector({ products, selectedId, onChange, disabled }: FluidProductSelectorProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        <div className="absolute z-50 mt-1 w-full max-h-60 overflow-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg">
