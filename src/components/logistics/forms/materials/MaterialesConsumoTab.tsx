...
export function MaterialesConsumoTab({ onSuccess, materials }: Props) {
  return (
    <MovementFormTab<MaterialMovementForm>
      ...
      bannerText="Registrar consumo de material"
      icon={Package}
      successMessage="Consumo de material registrado"
      errorMessage="Error al registrar el consumo"
