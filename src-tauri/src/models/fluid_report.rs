    ...
    pub fn update_header(
        ...
        conn.execute(
            "UPDATE fluid_reports SET
                rig_id=?1,
                report_date=?2, well_number=?3,
                rig_number=?4, contract=?5,
                contractor=?6, operator=?7,
                field_district=?8, supervisor_24h=?9,
                fluid_type=?10, well_phase=?11,
                fluid_coordinator=?12,
                tech_rep_1=?13, tech_rep_2=?14,
                trainee=?15, ops_supervisor=?16,
                bottom_down_min=?17, bottom_down_emb=?18,
                bottom_up_min=?19, bottom_up_emb=?20,
                well_cycle_min=?21, well_cycle_emb=?22,
                total_cycle_min=?23, total_cycle_emb=?24,
                vol_inicial=?25, vol_perdido_hoyo=?26,
                vol_descartado=?27, vol_preparado=?28,
                vol_transferido=?29, vol_recibido=?30,
                vol_perdido_sup=?31, vol_final=?32,
                esd=?33, ecd=?34,
                emb_n_tuberia=?35, emb_n_anular=?36,
                emb_k_tuberia=?37, emb_k_anular=?38,
                fluid_comments=?39,
                product_comments=?40,
                vol_comments=?41,
